...
#----------------------------------------------------------------
set_property -dict [list CONFIG.C_ALL_INPUTS {0} CONFIG.C_ALL_INPUTS_2 {0}] [get_bd_cells axi_gpio_0]
...
connect_bd_net [get_bd_pins axi_gpio_0/gpio2_io_o] [get_bd_pins axis_constant_0/cfg_data]
